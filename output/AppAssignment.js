/*
 ...
 Ang Theow Meng
 P7339041
 */import LoggedInForm from "./AssignmentOne/LoggedInForm.js";
import AddMember from "./AssignmentOne/AddMember.js";
import Member from "./AssignmentOne/Member.js";
import ChooseGenre from "./AssignmentOne/ChooseGenre.js";
import DisplaySelectedMovieToBePinned from "./AssignmentTwo/DisplaySelectedMovieToBePinned.js";
import { Provider } from "react-redux";
import storage from "./AssignmentTwo/storage.js";
import DisplayChooseMovie from "./AssignmentTwo/DisplayChooseMovie.js";
import { createHashRouter, Link, RouterProvider } from "react-router-dom";
import RootPage from "./AssignmentTwo/RootPage.js"; //Json data of movie list
const dataMovielist = [{
  id: 1,
...
function App(props) {
  ...
  const router = createHashRouter([{
    ...
    children: [{
      path: "/",
      element: /*#__PURE__*/React.createElement(Member
      ...
      path: "genre",
      element: /*#__PURE__*/React.createElement(ChooseGenre
      //  setgenreHandler={setgenreHandler}
      , null)
    }, {
      path: "addmember",
      element: /*#__PURE__*/React.createElement(AddMember, {
        onSubmitHandler: onSubmitHandler
      })
    }, {
      path: "pinnedmovie",
      element: /*#__PURE__*/React.createElement(DisplaySelectedMovieToBePinned, {
        resetMoviesToBePinned: resetMoviesToBePinned,
        movietobepinnedid: movietobepinnedid
      })
    }, {
      path: "editmovie",
      element: /*#__PURE__*/React.createElement(DisplayChooseMovie, null)
    }]
  }]);
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(RouterProvider, {
    router: router
  })));
}
